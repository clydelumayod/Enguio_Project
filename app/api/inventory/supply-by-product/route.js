...
export async function POST(request) {
  try {
    ...
    console.log('Supply by Product API called with:', { product, location });
    ...
    console.log('Supply by Product response:', result);
    
    return NextResponse.json(result);
    
  } catch (error) {
    console.error('Supply by Product API error:', error);
