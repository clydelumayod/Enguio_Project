...
export default function POS() {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      const rows = Math.ceil(filteredProducts.length / cols);
      ...
      switch (e.key) {
        ...
        case 'S':
          e.preventDefault();
          setSelectedIndex(prev => (prev + cols < maxIndex ? prev + cols : prev));
          break;
  ...
  }, [filteredProducts, quantityInputs, selectedIndex]);
      ...
      <div className="max-w-9xl mx-auto bg-white shadow-lg h-full">
        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="md:w-2/3 p-4 border-r h-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto h-[30rem]">
          ...
          <div className="md:w-1/3 p-4 h-full">
            <div className="bg-gray-50 rounded-lg p-4 h-full flex flex-col">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  <ul className="mb-4 max-h-96 overflow-y-auto flex-grow">
                    {cart.map(item => (
